...
export const translations = {
  'zh-CN': {
    ...
    filterSection: '节点过滤',
    filterSectionTip: '按名称关键词、国家或协议过滤节点；支持 /正则/ 语法，多个值用逗号分隔',
    filterInclude: '包含（名称关键词）',
    filterExclude: '排除（名称关键词）',
    filterIncludeCountry: '包含国家',
    filterExcludeCountry: '排除国家',
    filterIncludeType: '包含协议',
    filterExcludeType: '排除协议',
    filterCountryPlaceholder: '如：HK,JP,SG',
    filterTypePlaceholder: '如：ss,vmess,vless,trojan,hysteria2,tuic',
  ...
  'en-US': {
    ...
    filterSection: 'Node Filter',
    filterSectionTip: 'Filter nodes by name keyword, country or protocol; supports /regex/ syntax, comma-separated values',
    filterInclude: 'Include (name keyword)',
    filterExclude: 'Exclude (name keyword)',
    filterIncludeCountry: 'Include Countries',
    filterExcludeCountry: 'Exclude Countries',
    filterIncludeType: 'Include Protocols',
    filterExcludeType: 'Exclude Protocols',
    filterCountryPlaceholder: 'e.g. HK,JP,SG',
    filterTypePlaceholder: 'e.g. ss,vmess,vless,trojan,hysteria2,tuic',
  ...
  'fa': {
    ...
    filterSection: 'فیلتر نود',
    filterSectionTip: 'فیلتر نودها بر اساس کلمه کلیدی نام، کشور یا پروتکل؛ از نحو /regex/ پشتیبانی می‌کند، مقادیر با کاما جدا می‌شوند',
    filterInclude: 'شامل (کلمه کلیدی نام)',
    filterExclude: 'حذف (کلمه کلیدی نام)',
    filterIncludeCountry: 'کشورهای شامل',
    filterExcludeCountry: 'کشورهای حذف',
    filterIncludeType: 'پروتکل‌های شامل',
    filterExcludeType: 'پروتکل‌های حذف',
    filterCountryPlaceholder: 'مثلاً: HK,JP,SG',
    filterTypePlaceholder: 'مثلاً: ss,vmess,vless,trojan,hysteria2,tuic',
  ...
  'ru': {
    ...
    filterSection: 'Фильтр узлов',
    filterSectionTip: 'Фильтровать узлы по ключевому слову имени, стране или протоколу; поддерживается синтаксис /regex/, значения через запятую',
    filterInclude: 'Включить (ключевое слово имени)',
    filterExclude: 'Исключить (ключевое слово имени)',
    filterIncludeCountry: 'Включить страны',
    filterExcludeCountry: 'Исключить страны',
    filterIncludeType: 'Включить протоколы',
    filterExcludeType: 'Исключить протоколы',
    filterCountryPlaceholder: 'например: HK,JP,SG',
    filterTypePlaceholder: 'например: ss,vmess,vless,trojan,hysteria2,tuic',
